...
public class MPU9250Gyro {
	...
	public void readMagData(int[] destination)
	{
	  //TODO help
	  ...
	  long c = rawData[6]; // End data read by reading ST2 register
	...
	{  
	  ...
	  long ii, packet_count, fifo_count;
	  int[] gyro_bias = {0, 0, 0};
	...
	*/
	...
	// but is much less computationally intensive---it can be performed on a 3.3 V Pro Mini operating at 8 MHz!
	 ...
	 // measured ones. 
	            public void MahonyQuaternionUpdate(float ax, float ay, float az, float gx, float gy, float gz, float mx, float my, float mz)
	        {
	            float q1 = q[0], q2 = q[1], q3 = q[2], q4 = q[3];   // short name local variable for readability
	            float norm;
	            float hx, hy, bx, bz;
